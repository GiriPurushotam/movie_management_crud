...
<body>
	...
	<header class="site-header">
		<nav class="navbar">
			<div class="nav-left">
				<h1 class="logo"><a href="<?= BASE_PATH ?>/public/index.php">MovieDB</a></h1>
			</div>

			<div class="nav-center">
				<?php if ($currentPage !== 'login.php' && $currentPage !== 'signUp.php') : ?>
					<form action="<?= BASE_PATH ?>/public/search.php" method="GET" class="search-form">
			...
			<div class="nav-right">
				...
				<?php if ($currentPage !== 'add.php' && $currentPage !== 'edit.php' && $currentPage !== 'login.php' && $currentPage !== 'signUp.php'): ?>
					<a href="<?= BASE_PATH ?>/public/add.php" class="btn-add">+ Add Movie </a>
						...
						<?php if (isLoggedIn()): ?>
							<div class="user-menu">
								...
								<div class="user-dropdown">
									<a href="<?= BASE_PATH ?>/public/auth/logout.php">Logout</a>
								</div>
							</div>
						<?php endif; ?>
